	soc_system u0 (
		...
		.pio_activate_instruction_export       (<connected-to-pio_activate_instruction_export>),       //  pio_activate_instruction.export
		.pio_data_export                       (<connected-to-pio_data_export>),                       //                  pio_data.export
		.pio_instruction_export                (<connected-to-pio_instruction_export>),                //           pio_instruction.export
		.pio_wait_export                       (<connected-to-pio_wait_export>),                       //                  pio_wait.export
